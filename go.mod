...
replace github.com/cortexproject/cortex v1.11.1 => github.com/cortexproject/cortex v1.10.0

replace github.com/grafana/loki => github.com/muhammadn/loki v1.9.0
